...
#define	FN_ETC_VERSION		"etc/Version"		/* 風之塔版本 */
...
#define	FN_GAME_BBSNET	"game/bbsnet/bbsdata.db"	/* BBSNET 站台 */

/* ----------------------------------------------------- */
/* 各個版的檔名設定                                      */
/* ----------------------------------------------------- */
#define	BRD_ANNOUNCE	"Announce"
...
#define BRD_ORDERSONGS	"OrderSongs"
#define BRD_REQUEST	"Request"
