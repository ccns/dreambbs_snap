...
#define	BRD_NOREPLY	0x00000800	/* 不能回文章 */
#define	BRD_NOLOGREAD	0x00001000	/* 不紀錄看版閱讀率 */
#define	BRD_CHECKWATER	0x00002000	/* 紀錄灌水次數 */
#define	BRD_CHANGETITLE	0x00004000	/* 版主修改版名 */
#define	BRD_MODIFY	0x00008000	/* 使用者修改文章 */
#define	BRD_PRH		0x00010000	/* 推薦文章 */
#define	BRD_NOTOTAL	0x00020000	/* 不統計看板使用紀錄 */
