...
#define CHECK_LAZYBM
#undef	EADDR_GROUPING  /* Thor.980930: 若關閉時用 undef即可 */
...
#define DAY_NEWUSR	7	/* 10 login 不超過 3 次 */
#define DAY_FORFUN	30	/* 30 未完成身份認證 */
#define DAY_OCCUPY	90	/* 60 已完成身份認證 */
