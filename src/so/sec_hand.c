...
#define MSG_RES		"對不起，本功\能只限元智同學使用，您的認證信箱不在其內"
#endif

#define MSG_2ND		" \033[0;34;46m 跳蚤市場 \033[31;47m (ESC/←)\033[30m\
...
{
  clear();
  outs(" \033[0;36m─\033[1;33;46m WindTop 跳蚤市場 \033[0;36m──────\
──────────────────────\033[0m");
  move(f_size + 1, 0);
  outs(" \033[0;36m────────────────────────────\
──────────\033[0m");
