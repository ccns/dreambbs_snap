...
chat_record()
{
  ...
  {
    /* Thor.980602: ¥Ñ©ó tbf_ask»Ý°ÝÀÉ¦W, ¦¹®É·|¥Î¨ìigetch,
  ...
  int mode;
{
  ...
  if (!mode)
  {
    if(fmail)
    {
      ...
      holdon_fd = vio_fd;
      vio_fd = 0;      
      switch (vans("¥»¦¸²á¤Ñ«Ç¬ö¿ý³B²z (M)³Æ§Ñ¿ý (C)²M°£¡H[C] "))
      {
        case 'm':case 'M':
          {
            char tmp[64];
            ...
            strcpy(fhdr.title, "[³Æ §Ñ ¿ý] ²á¤Ñ«Ç¬ö¿ý");
  ...
  char *chatid;
{
  ...
  for (;;)
  {
	...
	/* Thor.0819: chatid arrayªø«×9, ¦ý¨S¶Ç¤J, ©Ò¥Hµwµ¹Åo */
...
{				/* ¦]¬°¤H¼Æ°Ê»³¤W¦Ê¡A·N¸q¤£¤j */
  printchatline("");
  printchatline("¡i " BOARDNAME "¹C«È¦Cªí ¡j");
...
t_chat()
{
  ...
  {
    move(b_lines-1,0);
    outs("­Y¤£¶i¤J²á¤Ñ«Ç¡A«h¼ÊºÙ½Ð¨Ï¥Î * ");
    ...
    /* Thor.0819: ®³±¼userno */
    /* Thor.0730: passwd §ï¬°³Ì«áªº°Ñ¼Æ */
    /* Thor.0813: passwd §ï¬°¯u¥¿ªºpassword, for C/S bbs */
    /* Thor.0813: xchatd¤¤, chatid ¦Û°Ê¸õ¹LªÅ¥Õ, ©Ò¥H¦³ªÅ¥Õ·| invalid login */

    /*
     * §@ªÌ  opus (¤H¥Í¦³¨ý¬O²MÅw)                                ¯¸¤º
     * sysopplan ¼ÐÃD  Re: Ãö©ó chatroom ®É¶¡  Wed Jul 30 03:14:56 1997
     * ¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w
     * ¢w¢w¢w
     * 
     * ¡° ¤Þ­z¡mThor (BBS°Ç§Ù³¡³¡ªø)¡n¤§»Ê¨¥¡G > ¡° ¤Þ­z¡mThor
     * (BBS°Ç§Ù³¡³¡ªø)¡n¤§»Ê¨¥¡G > > ¦pªG¥Î²Ä¤@©Û´N¤@¤F¦Ê¤F¤F...:p > >
     * ¨þ...¤£¦n·N«ä§â¾Çªø°½§ï¤F...:p >
     * ²Ä¤@©Û§@¦n¤F...¥i¬O¤£ª¾¹D·|¤£·|°Ê...:p > °½°Ý¤@¤U, passwd
     * ¬O³sÄòªº«DªÅ¥Õ¦r¤¸¶Ü?? ¤T­Ó°Ñ¼Æ userid + chatid + passwd ¤¤, userid /
     * chatid ¬Ò¤£§t space, ¦Ó passwd ¥i¥]§t space,
     * ©Ò¥H¥²¶·±N¥¦Â\¦b²Ä¤T­Ó¦ì¸m¥H«K token-parsing¡C
     * 
     * > ¥t¥~, ACCT ¤¤ªº passwd ¬OPASSLEN¦Û°Ê¸ÉªÅ¥ÕÁÙ¬O­n¤â°Ê¥[? > ·|¦Û°Ê¸Éº¡¶Ü?
     * Unix ªº crypt ³Ì¦h¥u¨ú«e 14 ­Ó¦r, ©Ò¥H¤£¥[¥ç¥i¡C³o­Ó¦a¤è °Ñ·Ó user
     * login ªº¦a¤è¼g´N¦n¤F¡C -- ¡° Origin: ·¬¾ôÅæ¯¸(bbs.cs.nthu.edu.tw)
