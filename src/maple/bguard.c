...
//#elif defined(SOLARIS)
  /* Thor.981207: 因需啟動rstat daemon, 故廢除, 以免造成security hole */
   struct statstime rs;
    rstat( "localhost", &rs );
